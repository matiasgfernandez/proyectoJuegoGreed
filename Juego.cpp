...
///  funcion para calcular los puntajes de la ronda
int puntajesRondas(int DadosBloqueadores[],int dados[],int cantidad, bool &duplico){
  ...
  bool  duplicar;
    ...
    if(cantidad>0){
        ...
        ///multiplica en caso que se cumpla con las condiciones
...
///  funcion para saber si todos los dados son iguales
